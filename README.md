...
- A token is used in the backend to pull specific data based off the token we pass in, that way you can authenticate users and pull their personal data instead of pulling the whole database.
- [ ] What steps can you take in your web apps to keep your data secure?
- form validation, token authorization, captcha??
- [ ] Describe how web servers work.
- They store, process and deliver pages to clients. They use HTTP Protocols.
